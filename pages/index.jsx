  ...
  return (
    <div>
      ...
      <main className={styles.q}>
        ...
        >
          <div className="absolute z-0 rotate-[] -top-20 max-w-full max-h-full overflow-hidden ">
            <img
          ...
          <div className="rounded-3xl mb-3 z-[5] bg-[#fefefe] backdrop-blur-md  bg-opacity-40">
            <div className="w-[70vw] max-w-[550px] mt-3 px-3 flex flex-wrap gap-2 duration-300 ">
              {selectedSymptom.map((symptom) => (
                <div
            ...
            <div className=" px-5 pt-3">
              ...
              />
              <div
                className={`flex flex-col origin-top overflow-y-auto max-h-[180px] mt-1  duration-300 `}
                // onClick={() => {
                //   setIsOpen(true);
                // }}
              >
            ...
            <div
              ...
              className="z-[5]  rounded-b-3xl mt-[3px] p-4  w-[70vw] max-w-[550px] text-center "
            >
          ...
          <div
            ...
            } duration-300 z-10 rounded-3xl  w-[70vw] bg-[#fefefe] backdrop-blur-md  bg-opacity-40 max-w-[550px] px-4 text-center py-5 rounded-b-3xl `}
          >
            {diseasesSymptom
